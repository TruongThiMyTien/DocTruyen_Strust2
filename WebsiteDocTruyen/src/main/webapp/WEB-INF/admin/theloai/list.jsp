	...
	<div class="container">
        ...
        <div class="row">
        	...
        	<div class="col-md">
				...
				<p>
					<a class="btn btn-primary" href="createTheLoaiAction">Thêm mới</a>
				</p>
				<table class="table table-bordered">
					...
					<c:forEach items="${lstTheLoai}" var="theloai">
						<tr>
							<td>${theloai.matheloai}</td>							
							<td>${theloai.tentheloai}</td>
							<td><a class="btn btn-warning" href="editTheLoaiAction?matheloai=${theloai.matheloai}">Sửa</a></td>
						</tr>	
					</c:forEach>
				</table>
        	</div>
