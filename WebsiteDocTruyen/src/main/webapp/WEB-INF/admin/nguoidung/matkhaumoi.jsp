...
<body>
	<div class="container">
        ...
        <div class="row">
        	...
        	<!-- Nội dung chính -->
        	<div class="col-md">
        		<h3 class="text-center">Cấp lại mật khẩu mới</h3>
        		<div class="row">
					<div class="col-md-10 offset-md-1">
						<form action="updatematkhauNguoiDungAction" method="post">
							<input name="manguoidung" type="hidden" value="${manguoidung}">							
							 <div class="form-group">
						 		<lable  class="control-label">Mật khẩu mới: </lable>
						 		<input name="matkhau" class="form-control" >
							 </div>							 
							 <div class="form-group">
							 	<input type="submit" value="Cấp" class="btn btn-primary px-5 my-3">
							 </div>
						</form>
					</div>
				</div>
