        ...
        <div class="row">
        	...
        	<div class="col-md">
				...
				<div class="d-flex flex-row-reverse">					
				  <a class="btn btn-danger px-5" href="deleteChuongAction?machuong=${chuong.machuong}&masach=${chuong.sach.masach}" onclick="return confirm('Bạn chắc chắn xóa?')">Xóa</a>
				  <a class="btn btn-warning px-5 mx-3" href="editChuongAction?machuong=${chuong.machuong}">Sửa</a>
				</div>
