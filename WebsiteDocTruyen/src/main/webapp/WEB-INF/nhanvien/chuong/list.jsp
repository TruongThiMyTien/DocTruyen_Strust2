	...
	<div class="container">
        ...
        <div class="row">
        	<div id="bentrai" class="col-md-3">
        		<h3>Quản lý</h3>
        		<ul>
        			<li><a href="listNVSachAction" >Danh sách sách</a></li>
        		</ul>
        		<h3>Tài khoản</h3>
        		<ul>
        	...
        	<div class="col-md">
				...
				<span>
					<a class="btn btn-primary" href="createNVChuongAction?masach=${sach.masach}">Thêm chương</a>
					<h3 class="my-2">Danh sách chương</h3>
					<ul>
						<c:forEach items="${lstChuong}" var="chuong">
							<li><a class="text-decoration-none" href="detailNVChuongAction?machuong=${chuong.machuong}">Chương ${chuong.chuongso}: ${chuong.tenchuong}</a></li>
						</c:forEach>
					</ul>
				</span>
